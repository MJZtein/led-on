...
function sizeHandler() {
    ...
    if (s_oMenuMode !== null) {
        s_oMenuMode.refreshButtonPos(s_iOffsetX, s_iOffsetY);
    }

    if (s_oLevelSelect !== null) {
        s_oLevelSelect.refreshButtonPos(s_iOffsetX, s_iOffsetY);
    }
...
function fullscreenHandler() {
    ...
    if (s_oMenuMode !== null) {
        s_oMenuMode.resetFullscreenBut();
    }

    if (s_oLevelSelect !== null) {
        s_oLevelSelect.resetFullscreenBut();
    }
}
